...
for (let counter = 0; counter < 10; counter++) {
    const company = {
        ...
        symbol: faker.random.alpha().toUpperCase() + faker.random.alpha().toUpperCase() + faker.random.alpha().toUpperCase(),
...
async function importDataCompanies() {
    ...
    for (const company of companies) {
        ...
        parameters.push(`($${parameterCounter},$${parameterCounter + 1},$${parameterCounter + 2})`);
        parameterCounter += 3;
    }
...
async function importDataInvestor() {
    ...
    for (const investor of investors) {
        ...
        parameters.push(`($${parameterCounter},$${parameterCounter + 1},$${parameterCounter + 2},$${parameterCounter + 3})`);
        parameterCounter += 4;
    }
