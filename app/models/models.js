...
Watch_list.belongsToMany(Company, {through: Watch_listCompany , foreignKey: 'list_id'});
Company.belongsToMany(Watch_list, {through: Watch_listCompany , foreignKey: 'company_id'});
